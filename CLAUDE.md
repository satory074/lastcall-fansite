...
- `/episodes/[id]/` — detail page (video + embedded cinderella + lineup vote table + sources + prev/next nav). **This is the cinderella's page too** — there is no separate cinderella route.
